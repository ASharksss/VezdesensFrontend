...
const FilteredSelectInput = ({mainId, data, setSelectValue, id, isRequired = false, mainValue = ''}) => { // data: [{id: int, name: str}]
    ...
    <div ref={wrapperRef}>
      ...
      <div className="Edited_appeal-select">
        ...
        <div className={open ? 'block Edited_filter_select-body' : 'filter_select-body-none'}>
          ...
          {
            data['characteristicValues'].map((item, index) => parseInt(item.name.split('@')[1]) === parseInt(mainId) &&(
...
export default FilteredSelectInput;
