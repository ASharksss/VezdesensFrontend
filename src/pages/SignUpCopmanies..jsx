        ...
        <div className='auth'>
            <form className="auth_form" onSubmit={handleSubmit}>
                ...
                {loading ? <div style={{
                    ...
                    <div style={{fontSize: 24, background: '#f6f6f6', padding: '10px 20px', borderRadius: 15}}>
                ...
                <div className="auth_form-inputs">
                    <div className='flex'>
                        <div className='reg_company-div'>
                            ...
                            <input type="text" placeholder='Введите ИНН' className='auth_form-input' required
                                   onChange={handleCheckINN} value={inn}/>
                        </div>
                        <div className='reg_company-div'>
                            <label className='block auth_form-label'>Наименование компании</label>
                            <input type="text" placeholder='Название компании' className='auth_form-input' required
                                   disabled
                    ...
                    <div className="flex">
                        ...
                        <div className='reg_company-div'>
                            ...
                            <InputMask mask="+7(999)999-99-99" className='auth_form-input'
