...
export const preloaderText = () => {
	const texts = ["Загружаем бесконечную вселенную... Подождите немного.",
		"Пока вы ждете, мы ищем потерянные пиксели на экране.",
		"Мы переворачиваем все биты и байты наизнанку, чтобы ускорить загрузку.",
		"Кушаем печенки... Очень вкусно!",
		"Прогресс... Но куда?",
		"Находим последнюю недосягаемую звезду в галактике... по прежнему в процессе.",
		"Загружаем котиков... Это займет немного времени, они такие пушистые!",
		"Ищем потерянное соединение... Может быть, оно прячется под ковриком?",
		"Загружаем позитивные вибрации... Уже почти готово!",
		"Играем в 'Скрываем и ищем' с вашими данными... Шутка, мы заботимся о вашей конфиденциальности!",
		"Загружаем магию интернета... Похоже, что-то волшебное уже происходит!"]
