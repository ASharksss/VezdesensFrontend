...
const ProfileContentAd = ({dataUser, setDataAds}) => {
  ...
  return (
    <div className='profile_content_ad'>
      ...
      {
        typeAd === 'archiveAd' ?
          <ArchiveAd dataUser={dataSearch} setDataAds={setDataAds} loading={loading} status={statusArchive}/> :
          typeAd === 'activeAd' ?
            <ActiveAds dataUser={dataSearch} setDataAds={setDataAds} loading={loading} status={status}/> : 'нишо'
      }
    </div>
  );
};
